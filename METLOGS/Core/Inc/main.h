...
/* Private defines -----------------------------------------------------------*/
#define PPS_NL3333_Pin GPIO_PIN_13
#define PPS_NL3333_GPIO_Port GPIOC
#define ExFlashEn1_Pin GPIO_PIN_4
#define ExFlashEn1_GPIO_Port GPIOA
#define RST_GNSS_Pin GPIO_PIN_8
#define RST_GNSS_GPIO_Port GPIOC
#define ExFlashEn2_Pin GPIO_PIN_9
#define ExFlashEn2_GPIO_Port GPIOC
